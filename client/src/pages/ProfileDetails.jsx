...
import { girleek11, girleek9, jfoulon } from "../assets";
      ...
      <div className=" flex flex-col justify-center md:items-center">
        <div className="xl:w-[60%] ">
          <TopBanner
            ...
            container={
              "flex flex-row items-end gap-2 mb-[0.2rem] md:ml-[-4rem]"
            }
            iconTrue={"hidden"}
            src={girleek11}
        ...
        <div className="md:pl-[8rem] lg:pl-[15rem] xl:pl-[20rem] 2xl:pl-[25rem] ">
          <article className="md:w-[100%] md:flex md:justify-center lg:w-[90%] xl:w-[60%]">
                  ...
                  <div className="flex flex-col ">
                    ...
                    <div className="bg-blue-bio rounded-xl py-2 px-3 m-1">
                      <p className="font-mainCond text-md font-extralight text-alt-white md:text-lg">
                        As the CEO of this organization, my mission is to bridge
                        the gender gap in technology and empower women to reach
                        their full potential in this industry.
                      </p>
                    </div>
                  </div>
          ...
          <article className="my-2 p-2 lg:p-4">
            <div className="flex flex-row items-baseline">
              <div className="w-[50%]  md:w-[40%]  2xl:w-[30%]">
            ...
            <div className="w-[80%]  md:w-[full] ml-4">
